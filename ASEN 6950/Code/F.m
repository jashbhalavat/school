...
function out = F(state0, statef, x_1_des, x_2_des, x_3_des, x_4_des)
    ...
    F2 = [statef(8:13) - state0(19:24); % x_2_f - x_3_0
            ...
            state0(14) - 1; % m_2_0 - init_mass
            statef(14) - state0(25)]; % m_2_f - m_3_0
    F3 = [statef(19:24) - state0(30:35); % x_3_f - x_4_0
            norm(state0(27:29))^2 - 1; % ||uhat3||^2 - 1
            statef(25) - state0(36)]; % m_3_f - m_4
    F4 = statef(30:35) - x_4_des; % x_4_f - x_4_des
