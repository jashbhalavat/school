...
[tout_halo, xout_halo] = ode113(@(t,state)CR3BP(state, mu), [0, halo_orbits(7,end)], halo_orbits(1:6,end), options);
...
legend("L1", "L2", "Earth", "Moon", "Initial Halo Orbit", "Final Lyapunov Orbit")
