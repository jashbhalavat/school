...
% ASEN 5010 - Project, Programming Assignment, Task 6
% Spring 2025
% Jash Bhalavat
...
print_array(sigma_BRs_at_0)
print_array(sigma_BRn_at_0)
print_array(sigma_BRc_at_0)

print_array(omega_BRs_B_at_0)
print_array(omega_BRn_B_at_0)
print_array(omega_BRc_B_at_0)
