...
[state, u, sigma_BR] = rk4(@(state, t, u_B, I_B)diff_eq(state, t, u_B, I_B), t_span, state_0, I_B, K, P, f);

sigma_BR_at_40 = sigma_BR(:, 4001);
sigma_BR_norm_at_40 = sqrt(sigma_BR_at_40(1)^2 + sigma_BR_at_40(2)^2 + sigma_BR_at_40(3)^2);
...
function [x, u_B, sigma_BR] = rk4(fn, t, x0, I_B, K, P, f)
