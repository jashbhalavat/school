...
sigma_BR_at_30 = sigma_BR(:, 3001);
sigma_BR_norm_at_30 = sqrt(sigma_BR_at_30(1)^2 + sigma_BR_at_30(2)^2 + sigma_BR_at_30(3)^2);
...
function [x, u_B, sigma_BR] = rk4(fn, t, x0, I_B, K, P, f)
    ...
    for i = 1:length(t)-2
        ...
        u_B(i,:) = (-K*sigma_BR(:,i) -P*omega_BN_B + skew_symmetric(omega_BN_B)*I_B*omega_BN_B)';
