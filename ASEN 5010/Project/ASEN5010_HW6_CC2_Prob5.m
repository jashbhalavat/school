...
sigma_BR_at_20 = sigma_BR(:, 2001);
sigma_BR_norm_at_20 = sqrt(sigma_BR_at_20(1)^2 + sigma_BR_at_20(2)^2 + sigma_BR_at_20(3)^2);
...
function [x, u_B, sigma_BR] = rk4(fn, t, x0, I_B, K, P, f)
    ...
    for i = 1:length(t)-2
        ...
        u_B(i,:) = (-K*sigma_BR(:,i) -P*omega_BR_B)';
